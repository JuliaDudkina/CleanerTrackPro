...
import EmployeeJobs from "./components/employees/EmployeeJobs";
...
const router = createRouter({
    ...
    routes: [
        ...
        {path: '/client/:id/update', component: UpdateClient, meta:{requiresAuth: true}},
        {path: '/client/:id/worksites', component: WorksitesList, meta:{requiresAuth: true}},
        {path: '/client/:id/worksites/register', component: AddWorksite, meta:{requiresAuth: true}},
        {path: '/client/:id/worksite/:key/update', component: UpdateWorksite, meta:{requiresAuth: true}},
